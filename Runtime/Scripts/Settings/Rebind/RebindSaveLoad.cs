...
namespace PTRKGames.MenuTemplate.Runtime.Settings.Rebind
{
    public class RebindSaveLoad : MonoBehaviour
    {
        ...
        public string playerPreferenceKey = "Rebind";
        ...
        private bool IsValidConfiguration()
        {
            ...
            {
                Debug.LogWarning(
                    "Unable to apply binding overrides from player preferences without an associated action asset.");
                return false;
            }
            ...
            {
                Debug.LogWarning(
                    "Unable to load binding overrides from player preferences without a non-empty preference key.");
                return false;
            }
